...
('2','Manage the application',NULL,1,NULL,NULL,NULL,'idm_admin_app',0,0),
('3','Manage roles',NULL,1,NULL,NULL,NULL,'idm_admin_app',0),
('4',',0Manage authorizations',NULL,1,NULL,NULL,NULL,'idm_admin_app',0),
('5','Get and assign all public application roles',NULL,1,0,NULL,NULL,NULL,'idm_admin_app',0,0),
('6','Get and assign only public owned roles',NULL,1,NULL,NULL,NULL,'idm_admin_app',0,0),
('increase-stck-0000-0000-000000000000','Order Stock','Increase Stock Count',0,'GET,0','/app/order-stock',NULL,'tutorial-dckr-site-0000-xpresswebapp',0),
('entrance-open-0000-0000-000000000000','Unlock','Unlock main entrance',0,'POST','/door/unlock',NULL,'tutorial-dckr-site-0000-xpresswebapp',0,0),
('alrmbell-ring-0000-0000-000000000000','Ring Alarm Bell',NULL,0,'POST','/bell/ring',NULL,'tutorial-dckr-site-0000-xpresswebapp',0,0),
('pricechg-stck-0000-0000-000000000000','Access Price Changes',NULL,0,'GET','/app/price-change',NULL,'tutorial-dckr-site-0000-xp,0resswebapp',0),
('managers-prxy-cbkr-0000-000000000000','Managers Context Broker Access','Proxy access for Managers',0,NULL,NULL,'<Rule RuleId="orion-acces,0s-mngr-0000-000000000000" Effect="Permit">\n<Description>Context Broker Access</Description>\n<Target>\n<AnyOf>\n<AllOf>\n<Match MatchId="urn:oasis:names:tc:xacml:3.0:function:string-starts-with">\n<AttributeValue DataType="http://www.w3.org/2001/XMLSchema#string">/v2/entities</AttributeValue>\n<AttributeDesignator Category="urn:oasis:names:tc:xacml:3.0:attribute-category:resource" AttributeId="urn:thales:xacml:2.0:resource:sub-resource-id" DataType="http://www.w3.org/2001/XMLSchema#string" MustBePresent="true" />\n</Match>\n</AllOf>\n</AnyOf>\n</Target>\n<Condition>\n<Apply FunctionId="urn:oasis:names:tc:xacml:3.0:function:any-of">\n<Function FunctionId="urn:oasis:names:tc:xacml:1.0:function:string-equal" />\n<AttributeValue DataType="http://www.w3.org/2001/XMLSchema#string">managers-role-0000-0000-000000000000</AttributeValue>\n<AttributeDesignator Category="urn:oasis:names:tc:xacml:1.0:subject-category:access-subject" AttributeId="urn:oasis:names:tc:xacml:2.0:subject:role" DataType="http://www.w3.org/2001/XMLSchema#string" MustBePresent="false" />\n</Apply>\n</Condition>\n</Rule>','tutorial-dckr-site-0000-xpresswebapp',0),
